...
class BayesianModel:
    ...
    def plot_confusion_matrix(self, curr_obs, obs_type):
        ...
        f1 = f1_score(true_label, predicted_label, pos_label='d', average='binary')
        recall = recall_score(true_label, predicted_label, pos_label='d', average='binary')
        precision = precision_score(true_label, predicted_label, pos_label='d', average='binary')
    ...
    def find_optimal_threshold(self, curr_likelihood_without_threshold):
        ...
        for obj_id in curr_likelihood_without_threshold:
            ...
            true_labels.append(1 if label == DEAD else 0)
    ...
    def predict_with_bayesian_threshold(self, curr_likelihood):
        ...
        for obj_id in curr_likelihood:
            ...
            if dead_logs_sum>alive_logs_sum+self.best_accuracy_threshold:
                cls=DEAD
